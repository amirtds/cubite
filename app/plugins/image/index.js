                ...
                <div className="items-center my-4">
                    ...
                    <div className='grid grid-cols-4 gap-2 -mt-6'>
                        <div className='col-span-3'>
                            <input type="text" value={caption ? caption : "Write caption here"} onChange={handleCaption} className="input input-bordered w-full" />
                        </div>
                        <CldUploadWidget uploadPreset="dtskghsx" onSuccess={handleUploadSuccess}>
                            {({ open }) => (
                                <button onClick={open} className="btn btn-outline btn-ghost col-span-1">
